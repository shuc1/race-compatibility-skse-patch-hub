...
;Added by Busy Follower Framework
BFFQuestLink Property BFFDialogueFollower Auto
...
; 	Debug.Trace("CSQ: Swapping followers.")
	...
	;if (PlayerFollowerCount.GetValue() > 0)
		...
		; Replaced by Busy Follower Framework
		BFFDialogueFollower.CompanionsDismissal()
	...
	;endif
	;Removed by Busy Follower Framework
