...
Spell Property VampireakFeedTargetDamage2 Auto
...
Spell Property VampireEnthrallNPC Auto
...
Keyword Property ImEnthralled Auto
...
EVENT OnEffectStart(Actor akFeedTarget, Actor akCaster)
	...
	If akFeedTarget.HasKeyword(ImATurnedVampire) == True  || akFeedTarget.HasSpell(VampireTurnToAshPileNPC)
			...
			EndIf
			If akFeedTarget == VampireTurnedVictimAlias02.GetActorReference()
				VampireTurnedVictimAlias02.Clear()
			EndIf
			If akFeedTarget == VampireTurnedVictimAlias03.GetActorReference()
				VampireTurnedVictimAlias03.Clear()
			EndIf
			If akFeedTarget == VampireTurnedVictimAlias04.GetActorReference()
				VampireTurnedVictimAlias04.Clear()
			EndIf
			If akFeedTarget == VampireTurnedVictimAlias05.GetActorReference()
				VampireTurnedVictimAlias05.Clear()
			EndIf
			If akFeedTarget == VampireTurnedVictimAlias06.GetActorReference()
				VampireTurnedVictimAlias06.Clear()
			EndIf
			If akFeedTarget == VampireTurnedVictimAlias07.GetActorReference()
				VampireTurnedVictimAlias07.Clear()
			EndIf
			If akFeedTarget == VampireTurnedVictimAlias08.GetActorReference()
				VampireTurnedVictimAlias08.Clear()
			EndIf
			If akFeedTarget == VampireTurnedVictimAlias09.GetActorReference()
				VampireTurnedVictimAlias09.Clear()
			EndIf
			If akFeedTarget == VampireTurnedVictimAlias10.GetActorReference()
				VampireTurnedVictimAlias10.Clear()
			EndIf
			If akFeedTarget == VampireTurnedVictimAlias11.GetActorReference()
				VampireTurnedVictimAlias11.Clear()
			EndIf
			If akFeedTarget == VampireTurnedVictimAlias12.GetActorReference()
				VampireTurnedVictimAlias12.Clear()
			EndIf
			If akFeedTarget == VampireTurnedVictimAlias13.GetActorReference()
				VampireTurnedVictimAlias13.Clear()
			EndIf
			If akFeedTarget == VampireTurnedVictimAlias14.GetActorReference()
				VampireTurnedVictimAlias14.Clear()
			EndIf
			If akFeedTarget == VampireTurnedVictimAlias15.GetActorReference()
				VampireTurnedVictimAlias15.Clear()
			EndIf
			If akFeedTarget == VampireTurnedVictimAlias16.GetActorReference()
				VampireTurnedVictimAlias16.Clear()
			EndIf
			If akFeedTarget == VampireTurnedVictimAlias17.GetActorReference()
				VampireTurnedVictimAlias17.Clear()
			EndIf
			If akFeedTarget == VampireTurnedVictimAlias18.GetActorReference()
				VampireTurnedVictimAlias18.Clear()
			EndIf
			If akFeedTarget == VampireTurnedVictimAlias19.GetActorReference()
				VampireTurnedVictimAlias19.Clear()
			EndIf
			If akFeedTarget == VampireTurnedVictimAlias20.GetActorReference()
				VampireTurnedVictimAlias20.Clear()
			EndIf
			If akFeedTarget == VampireTurnedVictimAlias21.GetActorReference()
				VampireTurnedVictimAlias21.Clear()
			EndIf
			If akFeedTarget == VampireTurnedVictimAlias22.GetActorReference()
				VampireTurnedVictimAlias22.Clear()
			EndIf
			If akFeedTarget == VampireTurnedVictimAlias23.GetActorReference()
				VampireTurnedVictimAlias23.Clear()
			EndIf
			If akFeedTarget == VampireTurnedVictimAlias24.GetActorReference()
				VampireTurnedVictimAlias24.Clear()
			EndIf
			If akFeedTarget == VampireTurnedVictimAlias25.GetActorReference()
				VampireTurnedVictimAlias25.Clear()
			EndIf
			If akFeedTarget == VampireTurnedVictimAlias26.GetActorReference()
				VampireTurnedVictimAlias26.Clear()
			EndIf
			If akFeedTarget == VampireTurnedVictimAlias27.GetActorReference()
				VampireTurnedVictimAlias27.Clear()
			EndIf
			If akFeedTarget == VampireTurnedVictimAlias28.GetActorReference()
				VampireTurnedVictimAlias28.Clear()
			EndIf
			If akFeedTarget == VampireTurnedVictimAlias29.GetActorReference()
	...
	ElseIf akFeedTarget.HasKeyword(ImEnthralled) == True
			...
			If akFeedTarget == VampireEnthrallAlias01.GetActorReference()
				...
				;Debug.Notification("Alias1 Cleared")
			EndIf
			If akFeedTarget == VampireEnthrallAlias02.GetActorReference()
				VampireEnthrallAlias02.Clear()
			EndIf
			If akFeedTarget == VampireEnthrallAlias03.GetActorReference()
				VampireEnthrallAlias03.Clear()
			EndIf
			If akFeedTarget == VampireEnthrallAlias04.GetActorReference()
				VampireEnthrallAlias04.Clear()
			EndIf
			If akFeedTarget == VampireEnthrallAlias05.GetActorReference()
				VampireEnthrallAlias05.Clear()
			EndIf
			If akFeedTarget == VampireEnthrallAlias06.GetActorReference()
				VampireEnthrallAlias06.Clear()
			EndIf
			If akFeedTarget == VampireEnthrallAlias07.GetActorReference()
				VampireEnthrallAlias07.Clear()
			EndIf
			If akFeedTarget == VampireEnthrallAlias08.GetActorReference()
				VampireEnthrallAlias08.Clear()
			EndIf
			If akFeedTarget == VampireEnthrallAlias09.GetActorReference()
				VampireEnthrallAlias09.Clear()
			EndIf
			If akFeedTarget == VampireEnthrallAlias10.GetActorReference()
				VampireEnthrallAlias10.Clear()
			EndIf
			If akFeedTarget == VampireEnthrallAlias11.GetActorReference()
				VampireEnthrallAlias11.Clear()
			EndIf
			If akFeedTarget == VampireEnthrallAlias12.GetActorReference()
				VampireEnthrallAlias12.Clear()
			EndIf
			If akFeedTarget == VampireEnthrallAlias13.GetActorReference()
				VampireEnthrallAlias13.Clear()
			EndIf
			If akFeedTarget == VampireEnthrallAlias14.GetActorReference()
				VampireEnthrallAlias14.Clear()
			EndIf
			If akFeedTarget == VampireEnthrallAlias15.GetActorReference()
				VampireEnthrallAlias15.Clear()
			EndIf
			If akFeedTarget == VampireEnthrallAlias16.GetActorReference()
				VampireEnthrallAlias16.Clear()
			EndIf
			If akFeedTarget == VampireEnthrallAlias17.GetActorReference()
				VampireEnthrallAlias17.Clear()
			EndIf
			If akFeedTarget == VampireEnthrallAlias18.GetActorReference()
				VampireEnthrallAlias18.Clear()
			EndIf
			If akFeedTarget == VampireEnthrallAlias19.GetActorReference()
