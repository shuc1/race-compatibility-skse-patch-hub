...
Function VampireProgression(Actor Player, int VampireStage)
	...
	If VampireStage == 2
		...
		Player.AddSpell(VampireInvisibilityPC, abVerbose = False)	
		Player.AddSpell(VampireCharm, abVerbose = False)
		Player.AddSpell(VampireFear, abVerbose = False)
		
		
		; We don't need to switch out Vampiric Drain anymore
		...
		; This spell is bad so lets get rid of it 
